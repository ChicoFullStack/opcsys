  ...
  return (
    <div className="isolate bg-white px-6 py-2 sm:py-4 lg:px-8">
      ...
      >
          ...
          <div className="sm:col-span-2">
            ...
            <div className="relative mt-2.5">
              <div className="absolute inset-y-0 left-0 flex items-center">
                ...
                >
                  <option>A.VPO261-A.VPO261</option>
                  <option>A.TC0004-A.TC0004</option>
                  <option>A.TC0005-A.TC0005</option>
                  <option>A.TC0006-A.TC0006</option>
                </select>
              </div>
              <input
                type="tel"
        ...
        <div className="flex gap-2 m-4 items-center"></div>
        <div className="mt-10">
          <button
            type="submit"
